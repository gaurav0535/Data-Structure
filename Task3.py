...
areaper = '{:,.2%}'.format(total_to_bangalore / total_from_bangalore)
print(f'{areaper} percent of calls from fixed lines in Bangalore are calls to other fixed lines in Bangalore.')